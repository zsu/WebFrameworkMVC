...
namespace Web.Controllers.Api
{
    ...
    public class TaskController : ApiController
    {
        ...
        public dynamic ExportToExcel([FromUri]JqGridSearchModel searchModel)
        {
            ...
            {
                searchModel.rows = 0;
                var data = GetQuery(Web.Infrastructure.Util.GetStatelessQuery<ScheduleTask>(),searchModel);
        ...
        private Web.Infrastructure.GridModel<ScheduleTask> GetQuery(IQueryable<ScheduleTask> query,[FromUri] JqGridSearchModel searchModel, int maxRecords = Constants.DEFAULT_MAX_RECORDS_RETURN)
        {
