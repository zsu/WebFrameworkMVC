...
namespace Web.Infrastructure
{
    public class Util
    {
        ...
        public const string LOG_LEVEl_SETTING_PREFIX = "logsettings.loglevel.";
        ...
        public static void ChangeLogLevels(Setting item)
        {
            try
            {
                ...
                string logLevelSettingPrefix = LOG_LEVEl_SETTING_PREFIX;
        ...
        public static GridModel<T> GetGridData<T>([System.Web.Http.FromUri] App.Mvc.JqGrid.JqGridSearchModel searchModel, IQueryable<T> query)
        {
            int totalRecords;
